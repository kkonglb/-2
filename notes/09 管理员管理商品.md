在router/index.js里面，添加【商品管理】的路由配置

![](https://cdn.nlark.com/yuque/0/2024/png/32649796/1734158151855-98e7a004-ea3d-4ca4-b7eb-5aeac92f8bd4.png)

```vue
{ path: "/productManage", name: '商品管理', icon: 'el-icon-shopping-bag-1', component: () => import(`@/views/admin/Product.vue`), meta: { requireAuth: true } },
```

在views/admin目录下，新建Product.vue文件
