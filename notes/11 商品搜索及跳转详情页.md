在router/index.js里面，添加【商品详情】路由配置![](https://cdn.nlark.com/yuque/0/2024/png/32649796/1734166646240-6e0b694c-9057-42fa-ab83-442743fceaf6.png)

```vue
 { name: '商品详情', path: "/product-detail", component: () => import(`@/views/user/ProductDetail.vue`), meta: { requireAuth: true } },
```

在views/user目录下，新建ProductDetail.v
...
使用下列完整的代码替换views/user目录下的Search.vue文件
...
使用下列完整的代码替换views/user目录下的Product.vue文件
