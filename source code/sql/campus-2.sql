...
CREATE TABLE `interaction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '互动行为信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `interaction` VALUES (59, 2, 22, 2, '2025-11-11 15:53:52');
INSERT INTO `interaction` VALUES (60, 2, 6, 2, '2025-11-11 15:56:13');
INSERT INTO `interaction` VALUES (61, 2, 7, 2, '2025-11-11 15:56:31');
INSERT INTO `interaction` VALUES (62, 2, 4, 2, '2025-11-11 16:02:52');
...
INSERT INTO `operation_log` VALUES (93, 8, '商品发货', '2025-11-11 16:01:15');
...
CREATE TABLE `orders`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '订单信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `orders` VALUES (22, '1762848059614', '测试', 2, 7, 129.90, 1, 2, '2025-11-11 16:01:03', 4, '2025-11-11 16:01:27', NULL, NULL, 0, 1, 1, '2025-11-11 16:01:15', 5, '2025-11-11 16:01:00');
INSERT INTO `orders` VALUES (23, '1762848180101', 'ceshi ', 2, 4, 1999.90, 1, 2, '2025-11-11 16:03:04', 4, '2025-11-11 16:03:25', NULL, NULL, 1, 1, NULL, NULL, NULL, '2025-11-11 16:03:00');
INSERT INTO `orders` VALUES (24, '1762848263117', 'ceshi1111', 2, 4, 1999.90, 1, 2, '2025-11-11 16:04:28', 4, '2025-11-11 16:04:45', 1, NULL, 0, 1, NULL, NULL, NULL, '2025-11-11 16:04:23');
...
INSERT INTO `product` VALUES (4, '苹果11', '<p>零食</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=5eb81a84.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=15d04683.png', 10, 1, 8, 18, 1999.90, 1, '2024-12-14 16:12:47');
...
INSERT INTO `product` VALUES (7, '洗衣机', '<p>零食</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=4b0513a11.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=b3554a24.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=4d108755.png', 9, 7, 8, 17, 129.90, 1, '2024-12-14 17:54:43');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'B站【程序员辰星】原创出品', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=49bf8cepic_6.jpg', '1343243@qq.com', 1, 0, 0, '2025-11-11 16:04:53', '2024-12-04 12:53:05');
INSERT INTO `user` VALUES (2, 'zhangfan', 'B站【程序员辰星】原创出品', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=0e61962pic_8.jpg', '12311323@qq.com', 2, 0, 0, '2025-11-11 15:53:27', '2024-08-16 16:12:12');
INSERT INTO `user` VALUES (7, 'liran', '李冉1', '14e1b600b1fd579f47433b88e8d85291', '/api/campus-product-sys/v1.0/file/getFile?fileName=1288932pic_8.jpg', '12434@qq.com', 1, 0, 0, '2025-11-11 15:55:05', '2024-10-19 06:39:12');
INSERT INTO `user` VALUES (8, 'lichen', '李琛', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=45aebe6pic_7.jpg', '12345@qq.com', 2, 0, 0, '2025-11-11 16:04:36', '2024-12-05 15:44:45');
